...
set VERSION=%2
set TITLE=%3
if "%TITLE%"=="" set TITLE=Minecraft Installer v%VERSION%
set NOTES_FILE=%4
...
echo Examples:
echo   %~nx0 delete-all
echo   %~nx0 create 1.1.2 "Minecraft Installer v1.1.2" notes\installer\RELEASE_NOTES_INSTALLER_v1.1.2.md
echo   %~nx0 reset-and-create 1.1.2
exit /b 1
