...
case "${1:-}" in
  ...
  create)
    ...
    VERSION="${2}"
    TITLE="${3:-Minecraft Installer v$VERSION}"
    NOTES_FILE="${4:-}"
  ...
  *)
    ...
    echo "Examples:"
    echo "  $0 delete-all"
    echo "  $0 create 1.1.2 'Minecraft Installer v1.1.2' notes/installer/RELEASE_NOTES_INSTALLER_v1.1.2.md"
    echo "  $0 reset-and-create 1.1.2"
    exit 1
    ;;
esac
